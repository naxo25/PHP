<?php
	...
	try{	
	    $sql = 'SELECT * FROM compras where id_cliente = 68';
	    $totalMax = 0;
		...
		echo "	
				...
				<td> $cantidad </td>
	    			...
	    			<td> $total </td>
	    		<td>
	    			<button class='btn btn-success btn-sm editIndividual' data-id=$id ><span class='glyphicon glyphicon-edit'></span> Editar</button>
	    			<button class='btn btn-danger btn-sm deleteIndividual' data-id='$id '><span class='glyphicon glyphicon-trash'></span> Eliminar</button>
	    		</td>
	    		</tr>
		"; 	$totalMax += $total;
